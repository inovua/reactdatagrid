...
const times = (count) => [...new Array(count)].map((_v, i) => i);
...
const renderNavBar = function (config, navBarProps) {
...
class MultiMonthView extends Component {
    ...
    renderView = (viewProps, index, size, keys, numberKeys) => {
        const props = this.p;
    ...
    onMonthNavigate = (dir, event, getNavigationDate) => {
        const props = this.p;
    ...
    onAdjustViewDateChange = (_dateString, { dateMoment, timestamp, }) => {
        const props = this.p;
    ...
    updateViewMoment = (_dateMoment, dir) => {
    ...
    onActiveDateChange = (_dateString, { dateMoment, timestamp, }) => {
    ...
    onChange = (_dateString, { dateMoment, timestamp, }, event) => {
