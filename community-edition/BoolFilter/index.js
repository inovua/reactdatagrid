...
export default class BoolFilter extends React.Component {
    ...
    render() {
        ...
        const finalEditorProps = typeof filterEditorProps === 'function'
            ...
            : filterEditorProps;
        return this.props.render(React.createElement(CheckBox, Object.assign({}, finalEditorProps, { readOnly: readOnly, disabled: this.props.disabled, onChange: this.onChange, supportIndeterminate: true, indeterminateValue: null, className: "InovuaReactDataGrid__column-header__filter InovuaReactDataGrid__column-header__filter--bool", checked: this.state.value })));
    }
}
